...
do
{
    echo "$str1"
    echo "  "
    time   ../src/entropy_01 ../PPR_data/"$data"/"$str1"_C ../PPR_data/"$data"/"$str1"_Matrix01 2 5 1000000 1 ../PPR_data/"$data"/"$str1"_
echo "  "
} &
done
wait
    ...
    do
        ...
        do
		    ...
		    do
                    ...
                    wait
                    ../src/filterCLK ../CLK_module/"$data"/"$str1"/e"$str2"_l"$j"_u"$i"/CLKmodule_"$nset".txt ../PPR_data/"$data"/"$str1"_Considered_genes ../PPR_data/"$data"/"$str1"_Ex_entropy.txt 0.8 0.04 ../out_module/"$data"/"$str1"/e"$str2"_l"$j"_u"$i"/SKmodule_"$nset".txt
